...
var ContrastAnalyser = function() {
    ...
    var _public = {
        ...
        test: function(hex1, hex2) {
            ...
            return (
                brightness >= _private.min.brightness && difference >= _private.min.difference ? ((brightness - _private.min.brightness) + (difference - _private.min.difference)) : false
            );
        },
        ...
        match: function(hex1, hex2) {
            ...
            return (
                best_match.score > 0 ? [best_match.hex1, best_match.hex2] : false
            );
        }
    };
    return _public;
